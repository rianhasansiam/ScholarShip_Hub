...
const ModaAllScholarship = ({scholarship}) => {
          ...
          <div className="modal-box">
            ...
            <div className="form-control mb-4">
              ...
              <input
                ...
                onChange={(e) => setSelectedScholarship({ ...selectedScholarship, name: e.target.value })}
            ...
            <div className="form-control mb-4">
              ...
              <input
                ...
                onChange={(e) => setSelectedScholarship({ ...selectedScholarship, universityName: e.target.value })}
                className="input input-bordered"
              />
            </div>
            <div className="form-control mb-4">
              ...
              <input
                ...
                onChange={(e) => setSelectedScholarship({ ...selectedScholarship, subjectCategory: e.target.value })}
                className="input input-bordered"
              />
            </div>
            <div className="form-control mb-4">
              ...
              <input
                ...
                onChange={(e) => setSelectedScholarship({ ...selectedScholarship, degree: e.target.value })}
                className="input input-bordered"
              />
            </div>
            <div className="form-control mb-4">
              ...
              <input
                ...
                onChange={(e) => setSelectedScholarship({ ...selectedScholarship, applicationFees: e.target.value })}
                className="input input-bordered"
              />
            </div>
