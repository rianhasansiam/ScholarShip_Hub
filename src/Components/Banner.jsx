...
const Banner = () => {
    return (
        <div >
            ...
            >
                <SwiperSlide>
                    <img className='w-[100vw] h-[75vh] object-cover  ' src="https://i.ibb.co.com/NLJT1kC/done1.jpg" alt="" />
                ...
                <SwiperSlide>
                    <img className='w-[100vw] h-[75vh] object-cover  ' src="https://i.ibb.co.com/TvD0Gd9/done33.jpg" alt="" />
                    <div className='text-white absolute h-[75vh] w-[100vw] z-20 top-0 text-center bg-black bg-opacity-65'>
                ...
                <SwiperSlide>
                    <img className='w-[100vw] h-[75vh] object-cover  ' src="https://i.ibb.co.com/1zWmgdz/done4.jpg" alt="" />
                    <div className='text-white absolute h-[75vh] w-[100vw] z-20 top-0 text-center bg-black bg-opacity-65 '>
                ...
                <SwiperSlide>
                    <img className='w-[100vw] h-[75vh] object-cover  ' src="https://i.ibb.co.com/0snksLv/donn2.jpg" alt="" />
                    <div className='text-white absolute h-[75vh] w-[100vw] z-20 top-0 text-center bg-black bg-opacity-65 '>
